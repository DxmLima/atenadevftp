...
function Stats() {
  return (
    <section id='services' class="bg-white dark:bg-primary p-6">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-2xl tracking-tight font-normal text-white dark:text-white">Our programming and design services are designed to help <br /> businesses of all sizes succeed.</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">
Atenadev services always guarantee better performance and elegance for your business in the digital world, <br />
enjoy our services!.</p>
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Marketing</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Websites</h3>
              <p class="text-gray-500 dark:text-gray-400">
Do you want to be a huge performer in the online world? <br />
Our sites are capable of doing this. We use the best tools on the market like Wordpress, React JS and Vue JS!</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Website Makeover</h3>
              <p class="text-gray-500 dark:text-gray-400"> Do you already have a website? but you are not liking the design and organization of the pages? <br /> we'll fix it and make your site much prettier and more elegant!</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Ransoware Remove</h3>
              <p class="text-gray-500 dark:text-gray-400">You made changes, installed plugins and your site is having problems, this could be a virus!
We can remove them for you!</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Logo Creation</h3>
              <p class="text-gray-500 dark:text-gray-400">Craft beautiful, delightful 
display a product that represents the face of your business!.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Templates</h3>
              <p class="text-gray-500 dark:text-gray-400">Entering the digital world and need a design and visual identity for your business? <br />
we will make it for you!</p>
          </div>
      </div>
  </div>
            ...
            <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                <a className=' ' href="https://api.whatsapp.com/send?phone=5519982668985&text=Olá%2C%20fiquei%20interessado%20(a)%20e%20gostaria%20de%20fazer%20um%20orçamento!">Make a budget </a>
            </span>
            </button>
             </div>
</section>
